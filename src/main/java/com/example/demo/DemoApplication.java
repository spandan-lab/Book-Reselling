...
// First the book needs to be sold by a user, which will have a flag of 1 in the database
// Another user can buy a book if the flag of the book is 1 using the bookId
